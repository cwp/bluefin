...
sql.foreignDataWrappers = 'select fdw.fdwname from pg_catalog.pg_foreign_data_wrapper fdw'

sql.foreignServers = 'select s.srvname from pg_catalog.pg_foreign_server s'
...
sql.largeObjects = 'select oid from pg_catalog.pg_largeobject_metadata order by oid'
